...
//client side code - To be specific - admin side
 //importing axios lib

var Noty = __webpack_require__(/*! noty */ "./node_modules/noty/lib/noty.js"); //importing noty lib which is used for "pop-up notifications"


var moment = __webpack_require__(/*! moment */ "./node_modules/moment/moment.js");

function initAdmin() {
  var orderTableBody = document.querySelector("#orderTableBody"); //coming from adminOrders.ejs

  var orders = [];
  var markup; //html markup is needed
  ...
  function renderItems(items) {
    ...
    return parsedItems.map(function (menuItem) {
      //map function will return array of object
      return "\n                <p>".concat(menuItem.item.name, " - ").concat(menuItem.qty, " pcs </p>\n            ");
    }).join(''); //to join all the paragraphs
  }
...
var Noty = __webpack_require__(/*! noty */ "./node_modules/noty/lib/noty.js"); //importing noty lib which is used for "pop-up notifications"
 ...
 //importing admin side code

var addToCart = document.querySelectorAll(".add-to-cart"); //selecting cart

var cartCount = document.querySelector(".cartCount"); //selecting number present in cart symbol

function updateCart(pizza) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post("/update-cart", pizza).then(function (res) {
    //'then' executes when server success
    ...
    new Noty({
      ...
      //green color
      timeout: 1000,
      //disappear after mentioned miliseconds (1 sec here)
      text: "Pizza added to cart" //pop-up msg
      // layout: "topCenter"        //to toggle position of pop-up

    }).show();
  })["catch"](function () {
    //'catch' executes when server error
    new Noty({
      type: "error",
      //red color
      timeout: 1000,
...
addToCart.forEach(function (btn) {
  btn.addEventListener("click", function (event) {
    //activates when ADD button clicked
    var pizza = JSON.parse(btn.dataset.pizza); //to convert string back to object (pizza coming from home.ejs)
...
(0,_admin__WEBPACK_IMPORTED_MODULE_1__.initAdmin)(); //admin side function called
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkpizza_realtime_website"] = self["webpackChunkpizza_realtime_website"] || [];
